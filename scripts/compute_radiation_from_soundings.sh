...
ifile=/run/media/ludo/DATA/google-drive/Thèse/EUREC4a/github/EUREC4A_cold_pools/input/all_sondes.nc
...
mkdir -p ${odir}/rad_profiles

python combine_reference_and_sonde_profiles.py --sonde_file=${ifile}
...
#To compute the radiative cooling itself, run instead
